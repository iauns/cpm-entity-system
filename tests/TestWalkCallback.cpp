...
public:
  ...
  static int preWalkCalls;
  static int postWalkCalls;
  static int numCalls;
...
int BasicSystem::preWalkCalls   = 0;
int BasicSystem::postWalkCalls  = 0;
int BasicSystem::numCalls       = 0;
...
TEST(EntitySystem, BasicConstruction)
{
  ...
  EXPECT_EQ(3, BasicSystem::numCalls);
  EXPECT_EQ(1, BasicSystem::preWalkCalls);
  EXPECT_EQ(1, BasicSystem::postWalkCalls);
}
